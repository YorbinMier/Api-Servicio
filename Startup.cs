...
namespace apiServicio
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<ItrnIngresoRepository, trnIngresoRepository>();
            services.AddTransient<ItrnIngresoService, trnIngresoService>();
            services.AddTransient<IclAlmacenRepository, clAlmacenRepository>();
            services.AddTransient<IclAlmacenService, clAlmacenService>();
